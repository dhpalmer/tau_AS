...
def main(): 
	...
	#a_dict, b_dict, c_dict, d_dict = make_dictionary(passfilt, a_down, b_down, c_down, d_down)

	gene_max_s1, gene_max_s2 = get_gene_max(passfilt, a_down, b_down, c_down, d_down)

	tau_s1, tau_s2 = get_tau(passfilt, a_down, b_down, c_down, d_down, gene_max_s1, gene_max_s2, gene_counts_s1, gene_counts_s2)
